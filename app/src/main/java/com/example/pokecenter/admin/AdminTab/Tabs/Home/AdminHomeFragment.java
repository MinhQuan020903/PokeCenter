package com.example.pokecenter.admin.AdminTab.Tabs.Home;
...
import com.example.pokecenter.admin.AdminTab.Tabs.Chat.AdminChatActivity;
import com.example.pokecenter.admin.AdminTab.Tabs.Home.OrdersManagement.AdminOrdersManagementActivity;
import com.example.pokecenter.admin.AdminTab.Tabs.Home.UsersManagement.AdminUsersManagementActivity;
import com.example.pokecenter.admin.AdminTab.Tabs.Home.ProductsManagement.AdminProductsManagementActivity;
import com.example.pokecenter.admin.AdminTab.Tabs.Home.StoreStatistic.AdminStoreStatisticActivity;
import com.example.pokecenter.admin.AdminTab.Tabs.Home.Supports.AdminSupportSelectionActivity;
import com.example.pokecenter.admin.AdminTab.Tabs.Home.VoucherManagement.AdminVoucherManagementActivity;
...
public class AdminHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.cvAdminSupports.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), AdminSupportSelectionActivity.class));
            }
        });
