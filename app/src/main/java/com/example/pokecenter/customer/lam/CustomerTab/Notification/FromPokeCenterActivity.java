...
import com.example.pokecenter.databinding.ActivityFromPokeCenterBinding;
...
public class FromPokeCenterActivity extends AppCompatActivity implements NotificationRecyclerViewInterface {

    private ActivityFromPokeCenterBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFromPokeCenterBinding.inflate(getLayoutInflater());
