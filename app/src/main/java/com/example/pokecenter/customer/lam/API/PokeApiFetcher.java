...
public class PokeApiFetcher {
    ...
    public static Pokemon fetchPokemonByName(String name) {
        try {
            ...
            JSONObject data = new JSONObject(inline);
            int pokemonId = data.getInt("id");

            String imageUrl = String.format("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/%d.png", pokemonId);
