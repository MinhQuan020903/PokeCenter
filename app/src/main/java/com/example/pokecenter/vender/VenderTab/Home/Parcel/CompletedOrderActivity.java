...
import com.example.pokecenter.databinding.ActivityCompletedOrderBinding;
...
public class CompletedOrderActivity extends AppCompatActivity {
    ...
    private ActivityCompletedOrderBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCompletedOrderBinding.inflate(getLayoutInflater());
        ...
        getSupportActionBar().setTitle("Delivery completed Orders");
    ...
    private void SetupData() {
        ...
        executor.execute(() -> {
            ...
            try {
                myPackagedOrders = new FirebaseSupportVender().fetchingOrdersWithStatus("Delivery completed");
            } catch (IOException e) {
                isSuccess = false;
            }
